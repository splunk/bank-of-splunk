...
if ! docker image inspect ghcr.io/splunk/bank-of-splunk/frontend:"$VERSION" > /dev/null 2>&1; then
...
if ! docker push ghcr.io/splunk/bank-of-splunk/frontend:"$VERSION"; then
  echo "Error: Push failed. Check your registry authentication."
  exit 1
fi

echo "Successfully pushed ghcr.io/splunk/bank-of-splunk/frontend:$VERSION"
